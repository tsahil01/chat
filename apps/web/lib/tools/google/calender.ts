import { tool } from 'ai';
import { z } from 'zod';
import { getCurrentUserGoogleAccount, createGoogleCalendarClient, handleGoogleError, createGoogleGmailClient } from './utils';

export const createCalendarEvent = tool({
    description: 'Create a new Google Calendar event',
    inputSchema: z.object({
        title: z.string().describe('Event title/summary'),
        startTime: z.string().describe('Start time in ISO format (e.g., 2024-01-20T10:00:00Z)'),
        endTime: z.string().describe('End time in ISO format (e.g., 2024-01-20T11:00:00Z)'),
